...
describe("List daily spending by period [GET] /metrics/daily-spending-in-period", () => {
  beforeAll(async () => {
  ...
  it("should be able to list daily spending by period", async () => {
    const response = await request(app.server)
      .get("/metrics/daily-spending-in-period")
      .set("Cookie", token)
      .send()
  ...
  it("should be able to list daily spending by period filtering date interval", async () => {
    const response = await request(app.server)
      .get("/metrics/daily-spending-in-period")
      .set("Cookie", token)
      .query({
