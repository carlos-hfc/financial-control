...
describe("List daily financial by period [GET] /metrics/daily-financial-in-period", () => {
  beforeAll(async () => {
  ...
  it("should be able to list daily financial by period filtering date interval", async () => {
    const response = await request(app.server)
      .get("/metrics/daily-financial-in-period")
      .set("Cookie", token)
      .query({
