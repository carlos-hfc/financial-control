...
export function Button({
  ...
  return (
    <Component
      className={cn(
        "rounded-md select-none outline-none font-medium flex items-center justify-center gap-2 disabled:opacity-50 disabled:pointer-events-none transition-colors text-sm",
