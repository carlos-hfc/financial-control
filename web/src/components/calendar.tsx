  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          "rounded-md select-none outline-none font-medium flex items-center justify-center gap-2 disabled:opacity-50 disabled:pointer-events-none transition-colors text-sm size-4 aria-disabled:opacity-50 p-0",
          defaultClassNames.button_previous,
        ),
        button_next: cn(
          "bg-transparent hover:bg-zinc-100 size-4 aria-disabled:opacity-50 p-0 select-none",
          defaultClassNames.button_next,
        ),
        month_caption: cn(
          "flex items-center justify-center h-4 w-full px-4",
          defaultClassNames.month_caption,
        ),
        dropdowns: cn(
          "w-full flex items-center text-sm font-medium justify-center h-4 gap-1.5",
        ...
        outside: cn(
          "text-muted-foreground aria-selected:text-zinc-50",
      ...
      components={{
        ...
        WeekNumber: ({ children, ...props }) => {
          return (
            <td {...props}>
              <div className="flex size-4 items-center justify-center text-center">
                {children}
              </div>
            </td>
          )
