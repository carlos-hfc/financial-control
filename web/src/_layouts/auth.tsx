...
export function AuthLayout() {
  return (
    <main className="h-svh flex">
      <section className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-blue-500 to-violet-900 p-12 text-white">
        <div className="max-w-lg mx-auto flex flex-col justify-center gap-12">
